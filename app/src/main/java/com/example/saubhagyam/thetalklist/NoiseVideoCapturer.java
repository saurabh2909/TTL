...
public class NoiseVideoCapturer extends BaseVideoCapturer {
    ...
    private final long mFrameProducerIntervalMillis = 1000 / FPS;
    private Handler mFrameProducerHandler;

    final Runnable mFrameProducer = new Runnable() {
        @Override
        public void run() {
